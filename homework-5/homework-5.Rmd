...
```
The overall ROC AUC is 0.6172083.

The model is not well enough since the overall accuracy is 0.3404255. 
...
Therefore, the confidence interval is (0.3734602, 0.4667246).