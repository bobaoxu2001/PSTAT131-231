...
results %>% 
  arrange(-accuracies)
```
Logistic Regression model achieved the highest accuracy on the training data since 0.8103933 is higher than others.
...
```
The model performs fairly, but not very accurately. The value differ because the model is for the training accuracy.
