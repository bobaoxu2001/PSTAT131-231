...
rplot(cor_titanic)
```
(1) sib_sp and parch (2) term and sib_sp (3) term and parch (4) passenger_od and age (5) are positively correlated.

(1) term and passenger_id (2) term and age (3) passenger and parch are negatively correlated.
...
```
The model performs accurately. Training accuracy (0.8089888) is little higher than testing accuracy (0.7988827) The value differ might due to that training accuracy means that identical images are used both for training and testing, while test accuracy represents that the trained model identifies independent images that were not used in training.
...
p(z) = $e^z \over 1+e^z$ $\Longrightarrow$ $p(z) (1+e^z)=e^z$ $\Longrightarrow$ $p(z) + p(z)e^z=e^z$ $\Longrightarrow$ $(1-p)e^z=p$ $\Longrightarrow$ $e^2=$${p}\over{1-p}$ $\Longrightarrow$ $z=ln($$p\over1-p$)

Therefore, $z(p)=ln($$p\over1-p$).
...
If I increase $x_1$ by two, then the odds of the outcome would be $e^{\beta_0+\beta_1(x_1+2)}$ = $e^{\beta_0+\beta_1x_1}e^2$, meaning that it would be $e^2$ times of original outcome.

p = ${e^{\beta_0 + \beta_1x_1} }\over {1+ e^{\beta_0 + \beta_1x_1}}$

As $x_1$ approaches $\infty$, p = ${e^{\beta_0 + \beta_1x_1} }\over {1+ e^{\beta_0 + \beta_1x_1}}$ = 0

As $x_1$ approaches $-\infty$, p = ${e^{\beta_0 + \beta_1x_1} }\over {1+ e^{\beta_0 + \beta_1x_1}}$ = 1