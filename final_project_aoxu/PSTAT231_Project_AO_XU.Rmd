...
Iris is a genus of flowering plants with 310 recognized species with colorful blooms. Iris is both the common name and the scientific name for all species of Iris, as well as some species from other closely related genera. Some species go by the common name "flags," and the plants of the subgenus Scorpiris are sometimes referred to as "junos," especially in gardening. It is a well-liked garden bloom.
...
It can predict the species of iris from the data about widths and lengths about sepal and petal.
...
For this part, the raw data is shown here. We clean the data set by setting species from "Iris-setosa", "Iris-versicolor" and "Iris-virginica" to 0, 1 and 2.
...
We split the data into training set and testing set for 0.8.
...
From this part we could find that if sepal length is lower, than it probably be Iris-setosa; if sepal length is higher, than it probably be Iris-virginica; Otherwise, it probably would be Iris-versicolor.
...
From this part we could find that if sepal wid is higher, than it probably be Iris-setosa or Iris-versicolor.
...
From this part we could find that if petal length is lower, than it probably be Iris-setosa; if sepal length is higher, than it probably be Iris-virginica; Otherwise, it probably would be Iris-versicolor.
...
From this part we could find that if petal width is lower, than it probably be Iris-setosa; if sepal length is higher, than it probably be Iris-virginica; Otherwise, it probably would be Iris-versicolor.
...
```{r,class.source = "fold-show"}
load("~/Documents/2022Fall/Pstat131/PSTAT231/lasso.RData")
load("~/Documents/2022Fall/Pstat131/PSTAT231/boost.RData")
load("~/Documents/2022Fall/Pstat131/PSTAT231/random_forest.RData")
load("~/Documents/2022Fall/Pstat131/PSTAT231/knn.RData")
```
